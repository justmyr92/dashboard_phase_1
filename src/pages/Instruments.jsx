...
const Instruments = () => {
    ...
    const viewRecord = (instrument) => {
        ...
        const getRecords = async () => {
            try {
                const response = await fetch(
                    `https://csd.dashboard.online/api/getRecords/${instrument.instrument_id}`
                );
                const jsonData = await response.json();
                setRecord(jsonData);
            ...
            if (result.isConfirmed) {
                editedRecords.map(async (record) => {
                    try {
                        console.log(record);
                        const response = await fetch(
                            `https://csd.dashboard.online/api/updateRecords`,
                            {
                                method: "PATCH",
    ...
    const updateInstrumentStatus = async (instrument_id, status) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await fetch(
                        "https://csd.dashboard.online/api/updateInstrumentStatus",
                        {
                            method: "PATCH",
                            headers: { "Content-Type": "application/json" },
