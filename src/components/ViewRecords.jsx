...
const ViewRecords = ({ setShowModal, record_data_id }) => {
    ...
    useEffect(() => {
        const getValues = async () => {
            ...
            const response = await fetch(
                `https://csddashboard/api/record_value/${record_data_id}`
            );
    ...
    const handleSave = async () => {
        recordValues.forEach(async (record) => {
            const response = await fetch(
                `https://csddashboard/api/update_record_values/${record.record_value_id}`,
                {
                    method: "PATCH",
                    headers: {
            ...
            if (response.ok) {
                ...
                const response = await fetch(
                    `https://csddashboard/api/record_data/${record_data_id}`,
                    {
                        method: "PATCH",
                        headers: {
                            "Content-Type": "application/json",
