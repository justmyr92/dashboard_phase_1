...
const SetNotification = ({
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const jsonData = await getUnitById(selected.unit_id);
                setUnit(jsonData);
    ...
    `;
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                const response2 = await addNotification(notif);
    ...
    return (
        <div
            ...
            tabIndex="-1"
            aria-hidden="true"
            className="z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full fixed inset-0 flex items-center justify-center w-full bg-black bg-opacity-50 transition-opacity duration-300"
        >
                ...
                <div className="relative w-full max-w-2xl max-h-full">
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="p-6 space-y-6">
                            <select
                                className="block w-[25rem] p-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:border-blue-300 focus:ring-2 focus:ring-blue-300 focus:ring-offset-2"
                                onChange={(e) => {
                                    setSelected({
                                        ...selected,
